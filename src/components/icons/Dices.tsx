...
const Dices = ({ tutorialStep }: DicesProps) => {
  ...
  return (
    ...
    >
      {/* Dé 1 */}
      <motion.g variants={diceVariants} animate={shouldAnimate ? "hovered" : "idle"}>
        <rect
          x="12.5"
          y="12.5"
          width="198.43"
      ...
      {/* Dé 2 */}
      <motion.g variants={dice2Variants} animate={shouldAnimate ? "hovered" : "idle"}>
        <rect
          x="168.88"
          y="156.47"
          width="198.43"
