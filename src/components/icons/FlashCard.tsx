...
export default function FlashCard() {
  ...
  return (
      ...
      >
        ...
        <motion.g variants={cardVariants} initial="initial" animate={isHovered ? "hovered" : "initial"} custom={0}>
          <rect
            className="cls-1"
            x="60.16"
            y="34.86"
        ...
        <motion.g variants={cardVariants} initial="initial" animate={isHovered ? "hovered" : "initial"} custom={1}>
        ...
        <motion.g variants={cardVariants} initial="initial" animate={isHovered ? "hovered" : "initial"} custom={2}>
          <rect
            className="cls-1"
            x="60.16"
            y="34.86"
